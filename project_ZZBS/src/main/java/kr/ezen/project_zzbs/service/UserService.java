...
import kr.ezen.project_zzbs.dto.UserCntDto;
import kr.ezen.project_zzbs.dto.UserDto;
import kr.ezen.project_zzbs.dto.UserJoinRequest;
...
public class UserService {
    ...
    public UserCntDto getUserCnt() {
        return UserCntDto.builder()
                ...
                .totalNoobCnt(userRepository.countAllByUserRole(UserRole.NOOB))
                .totalGeniusCnt(userRepository.countAllByUserRole(UserRole.Genius))
